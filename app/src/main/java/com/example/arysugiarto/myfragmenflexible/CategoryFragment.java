...
public class CategoryFragment extends Fragment implements View.OnClickListener{
    ...
    public void onClick(View v){
        ...
        String description = "Kategori ini akan berisi produk-produk lifstyle";
        mDetailCategoryFragment.setArguments(mBundle);
        mDetailCategoryFragment.setDescription(description);
        FragmentManager mFragmentManager = getFragmentManager();
        FragmentTransaction mFragmenTransaction  = mFragmentManager.beginTransaction();
        mFragmenTransaction.replace(R.id.frame_container,mDetailCategoryFragment,DetailCategoryFragment.class.getSimpleName());
        mFragmenTransaction.addToBackStack(null);
